...
CI enforces pinned Go and non-Go linters, a 70% aggregate coverage floor plus per-package ratchets, reachable-vulnerability and secret scans, immutable workflow action references, and fixed HIGH/CRITICAL image vulnerability checks.
...
HarborBuddy is licensed under the [MIT License](LICENSE).
